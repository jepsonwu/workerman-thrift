...
class ThriftWorker extends Worker
{
    ...
    public function __construct($socket_name)
    {
        ...
        $this->name = 'ThriftWorker';
        $this->onWorkerReload = array($this, 'onReload');
    }
    ...
    {
        //clear config
        Factory::config(null, null, "", true);

        //clear log
        Factory::logPoolClear();

        //clear db pool
        Factory::dbPoolClear();

        //clear redis pool
        Factory::redisPoolClear();

        //clear mongo pool
        Factory::mongoPoolClear();
    }
